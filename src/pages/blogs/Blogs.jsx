const Blogs = () => {
    return (
        <div>
            <div className="container my-10 min-h-[700px]">
                <div>
                    <h1 className="text-3xl font-primary font-bold">1. Difference between SQL and NoSQL</h1>
                ...
                <div className="mt-10">
                    <h1 className="text-3xl font-primary font-bold">2. What is JWT, and how does it work?</h1>
                ...
                <div className="mt-10">
                    <h1 className="text-3xl font-primary font-bold">3. What is the difference between javascript and NodeJS?</h1>
                ...
                <div className="mt-10">
                    <h1 className="text-3xl font-primary font-bold">4. How does NodeJS handle multiple requests at the same time?</h1>
