...
<footer className="footer px-10 py-4 border-t text-white  border-base-300">
  <div className="items-center grid-flow-col">
   <img className='w-10 h-10 rounded-full' src='https://img.freepik.com/free-photo/front-view-stacked-books-graduation-cap-diploma-education-day_23-2149241011.jpg' alt="" />
    <p>Orbital Academic care Ltd. <br/>Providing reliable teching since 2023</p>
  </div> 
